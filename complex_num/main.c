...
complex_t subtract_complex(complex_t, complex_t c2);
...
int main(void)
{
    ...
    printf("Enter the real number and imaginary parts of a  complex number\n");
...
/*
Complex output fraction display value as (a + bi) or (a - bi),
